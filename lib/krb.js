...
function getJob(miner, activeBlockTemplate, bashCache) {
    ...
    /*
    console.log("****************************getJob miner.cachedJob 0******************************");
    console.log(miner.cachedJob);
    console.log("****************************getJob miner.cachedJob 1******************************");
    */
    return miner.cachedJob;
}
...
function processShare(miner, job, blockTemplate, nonce, resultHash) {
    ...
    var hash = new Buffer(resultHash, 'hex');
    ...
    if (hashDiff.ge(blockTemplate.targetDiff)) {
        ...
        var convertedBlob = cnUtil.convert_blob(shareBuffer);
    ...
    console.log("hashDiff:"); console.log(hashDiff);
    console.log("job.difficulty" + job.difficulty);
    console.log("blockTemplate.targetDiff:" + blockTemplate.targetDiff);
    console.log("hashDiff > job.difficulty, valid share");
